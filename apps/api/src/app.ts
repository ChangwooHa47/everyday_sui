...
export function buildApp(logger = false, options?: { db: Database; auth: AuthConfig; ai?: AiConfig; aiLimits?: Pick<AiConfig, 'dailyLimit' | 'globalDailyLimit'>; market?: MarketChain; runtime?: MarketRuntime; memory?: MemoryProvider; gifts?: GiftService; product?: ProductOptions }) {
  const app = Fastify({
