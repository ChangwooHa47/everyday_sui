...
public class Character extends BaseTimeEntity {
    ...
    @jakarta.persistence.OrderColumn(name = "style_order")
    private List<String> speechStyles = new ArrayList<>();

    @ElementCollection
    @CollectionTable(name = "character_examples", joinColumns = @JoinColumn(name = "character_id"))
    @jakarta.persistence.OrderColumn(name = "example_order")
    private List<AuthoredExample> authoredExamples = new ArrayList<>();

    public void setAuthoredExamples(List<AuthoredExample> examples) {
        this.authoredExamples = new ArrayList<>(examples);
    }
    ...
    public void markSoulReady(boolean ready) { this.soulReady = ready; }
