...
public class EpisodeController {
    ...
    @GetMapping("/api/characters/{characterId}/episodes")
    public ApiResponse<List<EpisodeResponse>> listForCharacter(@PathVariable Long characterId) {
        return ApiResponse.ok(episodeService.list(SecurityUtils.getCurrentUserId(), characterId));
    }
    ...
    public ApiResponse<ChatMessageResponse> sendMessage(
        ...
        Long userId = SecurityUtils.getCurrentUserId();
        return ApiResponse.ok(episodeService.sendMessage(userId, characterId, episodeId, request.content(), request.requestId()));
    }
}
