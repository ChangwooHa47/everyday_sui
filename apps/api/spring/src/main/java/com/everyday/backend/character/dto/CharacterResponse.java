...
public record CharacterResponse(
        ...
        String callName,
        boolean soulTrained,
        boolean readOnlySettings
) {
    public static CharacterResponse from(Character character) {
        return from(character, false);
    }
    public static CharacterResponse from(Character character, boolean readOnlySettings) {
        return new CharacterResponse(
                ...
                List.copyOf(character.getSpeechStyles()),
                character.getProfileImageUrl(),
                character.getCallName(),
                character.isSoulReady(),
                readOnlySettings
        );
    }
}
